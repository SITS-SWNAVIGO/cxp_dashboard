...
def set_style():
    """Apply Modern Orange Power BI Style Theme"""
    st.markdown(
        """
        <style>

        /* ===============================
           GLOBAL BACKGROUND (ORANGE GRADIENT)
        ===============================*/
        .stApp {
        ...
        ===============================*/
        button {
            background: linear-gradient(135deg, #FF7A18, #FFB84D) !important;
...
def kpi_card(title, value, color="#FF7A18"):
    """Orange KPI card"""
    st.markdown(f"""
